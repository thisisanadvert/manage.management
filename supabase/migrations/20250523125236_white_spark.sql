/*
  # Fix Building Policies for Administrators
  
  1. Changes
    - Add policies for building administrators to update buildings
    - Add policies for authenticated users to create buildings
    - Update handle_new_user_signup function with SECURITY DEFINER
